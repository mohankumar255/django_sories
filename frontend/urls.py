...
from .views import home,select_category_data,create_post,get_data_ob,get_data_tags,delete_post,loginapiview,get_single_post
...
urlpatterns = [path('',home,name='home'),
               ...
               path('categories/<str:cat_name>',select_category_data,name = 'categories')
               ]
